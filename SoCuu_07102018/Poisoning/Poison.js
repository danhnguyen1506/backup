            ...
            return (
              <View style={styles.container}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Poison1')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../Images/nuot.webp')} position='absolute'/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Poison2')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../Images/hitphaikhidoc.webp')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Poison3')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../Images/bitiemvaotrong.webp')} position='absolute'/>
                    <View style={styles.overlay}/>
